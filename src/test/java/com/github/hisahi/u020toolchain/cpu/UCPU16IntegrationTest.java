...
public class UCPU16IntegrationTest {
     
    private UCPU16 cpu;
    public UCPU16IntegrationTest() {
    }
    ...
    public void testProgram1() {
        ...
        assertEquals("subroutine or shifting did not work correctly", 0x40, cpu.readRegister(Register.X));
    }
    
    @Test
    public void basicFpTest() {
        /// TODO if BASIC updates, this vector needs to be changed
        /// (reassemble BASIC, find FP0_sqrt from symbol table)
        final int FP0_sqrt = 0x37ef;
